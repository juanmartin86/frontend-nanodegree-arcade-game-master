...
// Function that returns a random item inside the array given
...
var Enemy = function(x, y) {
    this.x = x;     // x position
    this.y = y;     // y position
    this.acceleration = randomNumber(5, 1);     // acceleration of the enemies
...
// based on dt, a time delta between ticks
...
Token.prototype.update = function() {
    ...
    // and we also check every 2 seconds if the tokken will appear or not
...
// otherwise you'll be redirected to Udacity Website
Timer.prototype.handleInput = function (key) {
    ...
    if (!this.gameState) {
        ...
        // If player hits no, he or she will be redirected to Udacity Website
            ...
            alert('Thanks for playing! Now you are going to be redirected to the Udacity Website :)');
...
Timer.prototype.render = function() {
    ...
    if (!this.gameState) {
        ...
        ctx.fillText('Hit -> Y(es) or N(o)', 60, 405);
    }
};
...
var enemyLimits = 6;        // amount of enemies
